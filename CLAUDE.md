...
- Stage 4 stores CES benchmark and birth–death values in thousands and the raw QCEW revision sequence in jobs. Sample coverage/RSE is annual, the coverage share is explicitly an active-report proxy, and the RSE definitions are not harmonized across their documented break.
