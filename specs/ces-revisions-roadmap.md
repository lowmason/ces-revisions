...
- [ ] Stage 8: Benchmark anchors, wedge, post-March recursion, and mature horizon in the model\
      ...
      ROUTING: writing-plans — Stage 5 fixed the cumulative-job-change representation and positive reconstruction-error variance for all 23 public years; no representation design question remains.
