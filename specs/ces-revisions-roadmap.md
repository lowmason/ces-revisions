...
|---|---|---|---|
| 1 Vintage panel | missing | none found; `pyproject.toml:9` `dependencies = []` | 2026-09-15: Stage 3 (plan 5) shipped the content-hashed source archive, raw/transformation/long tables, and same-release differencing under `src/ces_revisions/vintages/` |
